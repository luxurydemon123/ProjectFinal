...
<body>
	<div class="container list-quiz">
        <h1 style="object-position: 20px" class="page-header">Online Quiz <img src="http://www.sgdbinhduong.com/public/images/hs.png" alt="Ranking"></h1>
        <form action="<?= base_url() ?>Quiz/QuestionStart/" method="POST" name="test-form" id="test-form">
