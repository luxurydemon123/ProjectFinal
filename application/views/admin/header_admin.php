      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-road"></i> <span>Learning roadmap</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-money"></i> <span>Deal</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-gift"></i> <span>Promotion Code</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-shopping-cart"></i> <span>App Store</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
