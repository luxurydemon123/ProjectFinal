    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-5">
            <div class="card">
              <img class="card-img-top" src="<?= base_url() ?>images/course/n5.png" alt="Card image cap">
              <div class="card-body">
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-5">
            <div class="card">
              <img class="card-img-top" src="<?= base_url() ?>images/course/n4.png" alt="Card image cap">
              <div class="card-body">
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-5">
            <div class="card">
              <img class="card-img-top" src="<?= base_url() ?>images/course/n3.png" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Intermediate Course</h5>
                <p style="font-size: larger;" class="card-body text-success">(Level N4, N3)</p>
                <p class="p-time">6 Months/level </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-5">
            <div class="card">
              <img class="card-img-top" src="<?= base_url() ?>images/course/n2.png" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Intermediate Course</h5>
                <p style="font-size: larger;" class="card-body text-success">(Level N4, N3)</p>
                <p class="p-time">6 Months/level </p>
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-5">
            <div class="card">
              <img class="card-img-top" src="<?= base_url() ?>images/course/N1.png" alt="Card image cap">
              <div class="card-body">
      ...
      <div class="container" style="max-width: 1140px;">
        ...
        <div class="row">
          <div class="col-sm-6 col-content">
           <form action="http://localhost:8888/Project2/Do_send" method="POST">
            <div>
